...
echo ""
echo "Dax requires PRD.md and EPICS.md in your repo root."
echo "Bootstrap will warn if they are missing or underspecified."
echo ""
...
echo ""
echo "Next steps:"
echo "  1. Create PRD.md in repo root (see examples in .dax/docs/examples/)"
echo "  2. Create EPICS.md with 3+ ranked epics"
echo "  3. Run: $TARGET_DIR/$INSTALL_DIR/agent/bootstrap.sh"
echo ""
echo "Dax cannot prevent implementation agents from hallucinating scope."
echo "A clear PRD and epic list is your mechanism for steering."
echo ""
